...
用法（真实宿主通过 CLI 文件协议逐判断作答后）：
    ...
    python3 examples/eval/realhost_profile.py \
        --case mechanism \
...
from examples.eval.cases import ConceptCase, ControversyCase, MechanismCase  # noqa: E402
from examples.eval.runner import (  # noqa: E402
    CaseReport,
    finalize,
    new_report,
    profile_learning,
