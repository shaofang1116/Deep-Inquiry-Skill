...
examples/eval/cases/mechanism.py；本文件仅保留同名入口 build_judgment，
...
from examples.eval.base import ScriptedHost  # noqa: E402
from examples.eval.cases.mechanism import MechanismCase  # noqa: E402
